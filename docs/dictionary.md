...
|:-------------------------------------------------------:|:----------------------------------:|:-------------------------------------:|:---------------------------------------:|:--------------------:|
|  [Modulus operator](manual.md#Arithmetical-operation)   |                                    |                                       |                                         |         `%`          |
...
|   [Equality operator](manual.md#Comparison-operation)   |                                    |                                       |                                         |         `==`         |
...
|            [List literal](manual.md#Literal)            |                                    |                                       |                                         |      `^`_X_`^`       |
|    [Logical operators](manual.md#Logical-operation)     |         `et`, `ou`, `non`          |            `e`, `o`, `non`            |             `y`, `o`, `no`              |  `&&`, `\|\|`, `!`   |
...
|     [Structure access](manual.md#Structure-access)      |      _X_` à la position `_Y_       |       _X_` alla posizione `_Y_        |        _X_` en la posición `_Y_         |     _X_` @ `_Y_      |
...
|             [Declared type](manual.md#Type)             |                                    |                                       |                                         |        `__`X         |
...
| [Declaration details A](manual.md#Variable-declaration) |          ` de valeur `_X_          |         ` con valore di `_X_          |           ` con valor de `_X_           |      ` := `_X_       |
