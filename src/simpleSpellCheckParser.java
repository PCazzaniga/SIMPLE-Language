...
public class simpleSpellCheckParser extends Parser {
	...
	public static final int RULE_file = 0, RULE_element = 1, RULE_mistake = 2;

	private final String[] ruleNames = new String[] { "file", "element", "mistake" };

	private final Vocabulary VOCABULARY;

	public simpleSpellCheckParser(TokenStream input, simpleLanguages.Lang language){
		super(input);
