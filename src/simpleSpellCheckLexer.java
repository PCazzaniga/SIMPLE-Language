...
public class simpleSpellCheckLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"NAME", "NUM", "TEXT", "LETTER", "DIGIT", "COMMENT", "TAB", "NEWLINE", 
	...
	/**************************************/
	private java.util.Deque<Token> stack = new java.util.ArrayDeque<>();
	...
	public simpleSpellCheckLexer(CharStream input) {
		super(input);
